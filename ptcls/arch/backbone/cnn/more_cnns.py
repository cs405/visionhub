"""More Advanced Backbones: HRNet, SqueezeNet, SE-ResNet, etc."""
...
@register_backbone('se_resnet18')
class SE_ResNet18(SEResNet):
    def __init__(self, num_classes=1000, pretrained=False):
        super(SE_ResNet18, self).__init__(SEBasicBlock, [2, 2, 2, 2], num_classes)


@register_backbone('se_resnet50')
class SE_ResNet50(SEResNet):
    def __init__(self, num_classes=1000, pretrained=False):
        super(SE_ResNet50, self).__init__(SEBottleneck, [3, 4, 6, 3], num_classes)


@register_backbone('se_resnet101')
class SE_ResNet101(SEResNet):
    def __init__(self, num_classes=1000, pretrained=False):
        super(SE_ResNet101, self).__init__(SEBottleneck, [3, 4, 23, 3], num_classes)
